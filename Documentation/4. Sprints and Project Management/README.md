...
| Server                         | * Setting up the Express Router for the module, linking it to the backend  * Setting up the API to host the data  * Creating GET and POST functions to communicate between the front-end and back-end (database) * Organising the Dockerfile and docker-compose file  * Creating routing for each collection within the database                                       | Wenda and Jessica     |
| Database                       | * Create a javascript file to access data from the database and post it to the API * Implement the database by loading in the CSV files  * Convert CSV file to JSON data for easier access                                                                                                                                                                             | Jessica               |
| Design / Prototyping           | * Handle ideation sessions  * Generate several paper prototypes  * Develop wireframe prototypes to assist front-end  * Create surveys and obtain data on relevant questions  * Organise and handle feedback sessions  * Maintain communication and relationships with the User Groups * Handle and maintain Product Backlog                                            | Emily and Hamza       |
| Quality Assurance and Testing  | * Develop Functional Tests  * Develop robust Unit Tests * Conduct the User Acceptance Testing                                                                                                                                                                                                                                                                          | Emily                 |
