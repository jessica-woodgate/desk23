...
The project will seek to fill this gap by providing an alternative data visualisation which responds to the brief of serious play, and seeks to make global literacy rates data interesting and fun, particularly for younger generations. The visualisation is interactive . A 3D globe format was chosen given the global nature of the issue of illiteracy, making this a natural way to visualise the data and bring out disparities between countries.
