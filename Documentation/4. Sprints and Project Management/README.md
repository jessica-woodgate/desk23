...
| Database                       | 
<ul> <li>Create a javascript file to access data from the database and post it to the API </li> <li> Implement the database by loading in the CSV files</li> <li>Convert CSV file to JSON data for easier access</li>   </ul>                                                                                                                                                                          | Jessica               |
